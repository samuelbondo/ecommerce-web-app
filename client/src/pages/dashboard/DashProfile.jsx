...
const s = {
  page: { padding: '16px', maxWidth: '720px', width: '100%', boxSizing: 'border-box', margin: '0 auto' },
  headerCard: { background: '#fff', borderRadius: '16px', padding: '16px', marginBottom: '20px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' },
  ...
  headerStats: { display: 'flex', alignItems: 'center', gap: '16px', background: '#f8f9fb', borderRadius: '12px', padding: '12px 14px', flexShrink: 0, flexBasis: 'auto' },
  hStat: { textAlign: 'center', minWidth: 0 },
  hStatNum: { fontWeight: '800', fontSize: '1rem', color: '#1a1a2e', wordBreak: 'break-word' },
  hStatLbl: { fontSize: '0.7rem', color: '#aaa', marginTop: '2px' },
  hStatDiv: { width: '1px', height: '32px', background: '#e5e7eb' },
  tabs: { display: 'flex', gap: '8px', marginBottom: '20px', flexWrap: 'wrap' },
  tab: { flex: '1 1 auto', padding: '9px 14px', borderRadius: '8px', border: '1px solid #e5e7eb', background: '#fff', cursor: 'pointer', fontSize: '0.82rem', color: '#555', fontWeight: '500', textAlign: 'center' },
  tabActive: { background: '#1a1a2e', color: '#fff', border: '1px solid #1a1a2e', fontWeight: '700' },
  card: { background: '#fff', borderRadius: '16px', padding: '16px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', gap: '16px' },
