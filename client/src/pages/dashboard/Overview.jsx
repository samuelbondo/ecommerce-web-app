...
const s = {
  ...
  welcome: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'linear-gradient(135deg, #1a1a2e, #16213e)', borderRadius: '16px', padding: '20px 16px', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' },
  ...
  card: { background: '#fff', borderRadius: '12px', padding: '14px', display: 'flex', alignItems: 'center', gap: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  cardIcon: { width: '42px', height: '42px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem', flexShrink: 0 },
  cardValue: { fontSize: '1.25rem', fontWeight: '700', color: '#1a1a2e' },
