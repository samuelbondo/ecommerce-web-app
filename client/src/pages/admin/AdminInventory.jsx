...
const s = {
  ...
  summary: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(120px,1fr))', gap: '14px', marginBottom: '20px' },
  ...
  search: { padding: '9px 14px', borderRadius: '8px', border: '1px solid #e5e7eb', fontSize: '0.88rem', width: '100%', maxWidth: '300px', outline: 'none', boxSizing: 'border-box' },
  ...
  adjustRow: { display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' },
  stockInput: { width: '68px', minWidth: '60px', padding: '7px 10px', borderRadius: '7px', border: '1px solid #e5e7eb', fontSize: '0.88rem', outline: 'none' },
