...
const styles = {
  ...
  title: { fontSize: '1.6rem', marginBottom: '4px' },
  ...
  cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 20px', flexWrap: 'wrap', gap: '8px' },
  orderId: { fontWeight: '700', fontSize: '1rem', marginRight: '12px' },
  date: { color: '#888', fontSize: '0.85rem' },
  right: { display: 'flex', alignItems: 'center', gap: '12px' },
  badge: { color: '#fff', padding: '3px 10px', borderRadius: '20px', fontSize: '0.78rem', fontWeight: '600' },
  total: { fontWeight: '700', color: '#1a1a2e', fontSize: '1rem' },
  divider: { height: '1px', background: '#f0f0f0' },
  items: { padding: '12px 20px', display: 'flex', flexDirection: 'column', gap: '12px' },
  item: { display: 'flex', alignItems: 'center', gap: '14px' },
  img: { width: '56px', height: '56px', objectFit: 'cover', borderRadius: '8px', flexShrink: 0 },
  itemInfo: { flex: 1, display: 'flex', flexDirection: 'column', gap: '2px' },
  itemName: { fontWeight: '500', fontSize: '0.95rem' },
  itemQty: { color: '#888', fontSize: '0.82rem' },
